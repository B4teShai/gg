...
echo "---- selfGNN-Base done. Result: $RESULTS_DIR/finance_merchant_base.json"
...
echo "---- selfGNN-Feature (edge) done. Result: $RESULTS_DIR/finance_merchant_edge.json"
...
(
  ...
  python train.py \
    ...
    --use_edge_features \
    --use_node_features \
    --save_path "finance_merchant_full"
)
echo "---- selfGNN-Feature (full) done. Result: $RESULTS_DIR/finance_merchant_full.json"
...
for TAG in finance_merchant_base finance_merchant_edge finance_merchant_full; do
