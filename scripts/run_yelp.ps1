...
#
# Usage:
#   .\run_yelp.ps1 [-Device cuda|mps|cpu] [-Epoch N] [-Seed N]
...
Write-Host "---- done -> $ResultsDir\yelp_merchant_base.json"
...
Write-Host "---- done -> $ResultsDir\yelp_merchant_node.json"
...
Write-Host "---- done -> $ResultsDir\yelp_merchant_edge.json"
...
Write-Host "---- done -> $ResultsDir\yelp_merchant_node_edge.json"
