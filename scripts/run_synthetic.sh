...
echo "---- done → $RESULTS_DIR/synthetic_merchant_base.json"
...
echo "---- done → $RESULTS_DIR/synthetic_merchant_node.json"
...
echo "---- done → $RESULTS_DIR/synthetic_merchant_edge.json"
...
echo "---- done → $RESULTS_DIR/synthetic_merchant_node_edge.json"
